...
<p align="center">
<img src="https://user-images.githubusercontent.com/68056295/167522747-4ff88b3c-29e1-4d33-b725-300a4d2e6ac8.png" width="95%" height="95%"></center>
</p>

<p align="justify">
     The AISFMs are solar farside line-of-sight magnetograms generated by a deep learning model.
     We generated them by the model from the corresponding Extreme UltraViolet (EUV) observations of STEREO Ahead (A) or Behind (B).
...
<p align="justify">
     We made an upgraded model including a correlation coefficient based objective with additional input data: not only the farside STEREO EUV images but also the frontside data pairs of SDO EUV images and magnetograms as reference information.
...
<p align="justify">
     The AI-generated data produced by the Sun and Space Weather Laboratory (SSWL) at Kyung Hee University (KHU) and released by the Korea Astronomy and Space Science Institute (KASI).
...
<p align="justify">
     We generated solar farside magnetograms from the STEREO EUV images and the frontside reference data pairs by the Pix2PixCC model.
     The EUV passbands of the STEREO were 30.4, 19.5, and 17.1 nm.
     The reference data pairs were SDO EUV images and magnetograms which were selected by considering the separation angle between the STEREO and the SDO.
     When we train and evaluate the model with the frontside datasets, the reference pairs were replaced by the pairs that were observed one solar rotation (27.3 days) before.
</p>
