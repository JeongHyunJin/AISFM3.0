...
;+
; NAME:
;     IDL_Visualizations_of_AISFMs.pro
;
; Syntax: 
;     IDL_Visualizations_of_AISFMs,fpath,/SSW,/DirectGraphic,/PrintHeader
;
; PURPOSE:
...
PRO IDL_Visualizations_of_AISFMs, Filename, $
                                  SSW=SSW, $
...
; Create a window and display the AISFM.
    ...
    IF NOT KEYWORD_SET(DirectGraphic) THEN BEGIN
        ...
        ; Set dynamic range: -100 ~ +100 Gauss
...
;_________________________________________________________________________
; Check the header information of the AISFM.
